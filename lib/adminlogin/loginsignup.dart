...
import 'package:zorba_greek/adminlogin/reggi.dart';
import 'loginnnn.dart';
        ...
        child: Column(
          children: [
            const Padding(
              ...
              child: Text("Hello There!",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.white),),
            ),
            const Padding(
            ...
            Image.network('https://as2.ftcdn.net/v2/jpg/05/00/82/47/1000_F_500824703_iLA3mEkxcQFOPmjQaNHHYwq34VisNW8I.jpg'),
