...
import 'package:zorba_greek/adminlogin/helperclass.dart';
...
class _Signup_FormState extends State<Signup_Form> {
  ...
  Widget build(BuildContext context) {
    void Addnewuser(String name, String email, String password) async {
      var id = await SQLHelperr.AddNewUser(name, email, password);
      if (id != null) {
              ...
              ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (valid1) {
                      ...
                      var data = await SQLHelperr.userFound(name, uname);
