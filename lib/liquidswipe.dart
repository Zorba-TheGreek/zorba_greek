...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Colors.blue, "images/apple logo.png", "Hi", "It's Me", "Sahdeep"),
    ItemData(Colors.deepPurpleAccent, "images/apple logo.png", "Take a", "Look At",
        "Liquid Swipe"),
    ItemData(Colors.green, "images/apple logo.png", "Liked?", "Fork!", "Give Star!"),
    ItemData(Colors.yellow, "images/apple logo.png", "Can be", "Used for",
        "Onboarding design"),
    ItemData(
        Colors.pink, "images/apple logo.png", "Example", "of a page", "with Gesture"),
    ItemData(Colors.red, "images/apple logo.png", "Do", "try it", "Thank you"),
  ];
